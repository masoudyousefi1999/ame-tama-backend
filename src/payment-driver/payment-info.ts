export class PaymentInfo {
  ...
  public getScript() {
    ...
    Object.keys(params).forEach((key) => {
      ...
      script += `var multipay_hidden_field__${key} = document.createElement("input");multipay_hidden_field__${key}.setAttribute("name", ${key});multipay_hidden_field__${key}.setAttribute("value", ${value});form.appendChild(multipay_hidden_field__${key});`;
    });
